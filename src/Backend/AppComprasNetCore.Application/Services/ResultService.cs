...
public class ResultService
{
    ...
    public static ResultService RequestErro(string message, ValidationResult validationResult)
    {
        return new ResultService
        {
            IsSucess = false,
            Message = message,
            Errors = validationResult.Errors.Select(x => new ErrorValidator
            {
    ...
    public static ResultService<T> RequestErro<T>(string message, ValidationResult validationResult)
    {
